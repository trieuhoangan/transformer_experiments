...
@register_task('acn_tags_translation')
class ACNTagsTranslationTask(FairseqTask):
    """
    ...
    def load_pretrained_model(path, src_dict_path, tgt_dict_path, src_tags_dict_path, arg_overrides=None):
        ...
        task = ACNTagsTranslationTask(args, src_dict, tgt_dict, src_tags_dict)
