...
DATA_PATH="$HOME/pascal/data/iwslten2vi/VOLT_en2vi/iwslt_VOLT_en2vi"
TEST_FILE="$DATA_PATH/test.$TGT_LANG.depbe"
CKPT_PATH="$HOME/checkpoint/dep_transformer/iwslten2vi/transformer_VOLT"
MODEL_DIR=$PROJ_PATH/transformer
OUTPUT_FN=$MODEL_DIR/res.txt
MOSES_LIB="$HOME/pascal/mosesdecoder"
