...
SRC_LANG=en
TGT_LANG=vi
PATH_DATA="$HOME/checkpoint/dep_transformer/iwslten2vi/trans_add_pos_tag_ave"
...
fairseq-generate ${PATH_DATA_BIN} \
        ...
        --user-dir $USER_DIR --tags-data $TAGSDIR \
        --criterion label_smoothed_cross_entropy --task tags_translation \
