...
TAGS_PATH="$HOME/pascal/data/iwslten2vi/tags_root/fairseq0102iwsltvi2en2"
SUBTAGSDIR="$HOME/pascal/data/iwslten2vi/sub_tags/reorder_sub_tags"
CKPT_PATH="$HOME/checkpoint/dep_transformer/iwsltvi2en/change_embed4"
