...
model_dir="$HOME/checkpoint/dep_transformer/iwsltvi2en/ACN"
mkdir -p $model_dir
...
CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES fairseq-train $data_bin \
        ...
        --log-interval 100 --save-interval-updates 1000 --keep-interval-updates 1 --save-interval 10000 --seed 1111 \
        --ddp-backend no_c10d \
        --dropout 0.15 \
        --tensorboard-logdir $model_dir \
        -s vi -t en --save-dir $model_dir \
